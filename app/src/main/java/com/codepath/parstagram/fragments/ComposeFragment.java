...
public class ComposeFragment extends Fragment {
    ...
    private void launchCamera() {
        // create Intent (implicit) to take a picture and return control to the calling application
        ...
        intent.putExtra(MediaStore.EXTRA_OUTPUT, fileProvider); // where the output goes
